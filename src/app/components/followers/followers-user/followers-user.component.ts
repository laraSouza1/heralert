...
import { FollowingUserComponent } from '../following-user/following-user.component';
...
@Component({
  selector: 'app-followers-user',
  imports: [
    IconFieldModule, InputIconModule, InputTextModule, TableModule, CommonModule, ButtonModule,
    FollowButtonComponent
  ],
  templateUrl: './followers-user.component.html',
  styleUrl: './followers-user.component.css'
})
export class FollowersUserComponent implements OnInit {
